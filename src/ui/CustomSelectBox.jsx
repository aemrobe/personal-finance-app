  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`outline-none  focusable-ring flex shrink-0 md:border  items-center rounded-lg  disabled-input ${widthOfTriggerButton} ${heightOfTriggerButton} ${isFilterType ? ` justify-center p-[2.5px] md:py-3 md:px-5  rounded-none md:rounded-lg` : "border rounded-lg py-3 px-5 border-border-base"} ${visible ? "border-content-main" : "md:border-border-base `"}`}
      >
        {isColor && (
          <span
            aria-hidden="true"
